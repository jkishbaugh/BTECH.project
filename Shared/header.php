...
<header>
    <div class="navbar">
        <nav>
            <ul>
                <li><a href="<?php echo PUBLIC_PATH.'/public/index.php'; ?>">Home</a></li>
                <li><a href="<?php echo PUBLIC_PATH.'public/about.html'; ?>">About</a></li>
                <li><a href="<?php echo PUBLIC_PATH.'public/faq.html'; ?>">FAQ</a></li>
                <li><a href="<?php echo PUBLIC_PATH.'public/contact.php'; ?>">Contact</a></li>
                <li><a href="<?php echo PUBLIC_PATH.'public/blog.html'; ?>">Blog</a></li>
